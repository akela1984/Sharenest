        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <div class="d-flex flex-column flex-lg-row align-items-center ms-auto">
                <div class="horizontal-buttons d-flex flex-row justify-content-center mb-3 mb-lg-0">
                    <a class="btn btn-outline-success me-2 mb-2 mb-lg-0" href="my_nest.php">My Nest</a>
                    <a class="btn btn-outline-success me-2 mb-2 mb-lg-0" href="create_listing.php">Create Listing</a>
                    <?php if (!isset($_SESSION['loggedin']) || !$_SESSION['loggedin']) { ?>
                        <a class="btn btn-outline-success mb-2 mb-lg-0" href="signin.php">Sign in</a>
                    <?php } ?>
                </div>
                <div class="d-flex flex-row justify-content-center mb-3 mb-lg-0">
                    <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin']) { ?>
                        <a class="nav-link position-relative me-3" href="my_messages.php">
                        ...
                        <a class="nav-link me-3" href="my_dashboard.php">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width: 24px; height: 24px; fill: currentColor;">
                        ...
                        <?php if ($is_admin) { ?>
                            <a class="nav-link position-relative me-3" href="admin_panel.php">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width: 24px; height: 24px; fill: currentColor;">
